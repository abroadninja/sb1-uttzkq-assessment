...
import { personalitySection, riasecSection } from './data/personalityQuestions';
...
function App() {
  const { currentCategoryIndex, nextCategory, previousCategory, currentSection } = useAssessmentStore();
  const currentSectionCategories = currentSection === 'personality' ? personalitySection.categories : riasecSection.categories;

  const currentCategory = currentSectionCategories[currentCategoryIndex];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="max-w-3xl mx-auto text-center mb-8">
            ...
            {currentSection === 'riasec' && (
              <>
                <h2 className="text-3xl font-bold text-gray-900 sm:text-4xl">
                  Section 2: Interest Inventory (RIASEC Model)
                </h2>
                <p className="mt-4 text-lg text-gray-600">
                  Complete this section to identify your interests and how they relate to
          ...
          <div className="max-w-2xl mx-auto flex justify-between pb-8">
            ...
            <button
              ...
              disabled={currentCategoryIndex === currentSectionCategories.length - 1}
